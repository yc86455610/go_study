...
// SntBlocksChainCheck 根据提币的数量，提币方地址以及目标方地址来检查提币是否已经confirmed.
// 返回值有两个：提币状态以及已收到的提币数量（扣除手续费）
func SntBlocksChainCheck(withdrawAmount float64, originalAddress string, targetAddress string) (status string, netWithdrawAmount float64, confirmations int64, err error) {
...
func main() {
	status, netReceiveAmount, confirmations, err := SntBlocksChainCheck(248236625000000, "0x60C972E45e2E23E4adc818310698b2dEe7912660", "0xd154a7515647e3beac8b7c241e7ea47049d4b7e0")
	if err != nil {
