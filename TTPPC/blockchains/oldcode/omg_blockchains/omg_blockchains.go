...
// OmgBlocksChainCheck 根据提币的数量，提币方地址以及目标方地址来检查提币是否已经confirmed.
// 返回值有两个：提币状态以及已收到的提币数量（扣除手续费）
func OmgBlocksChainCheck(withdrawAmount float64, originalAddress string, targetAddress string) (status string, netWithdrawAmount float64, confirmations int64, err error) {
...
func main() {
	status, netReceiveAmount, confirmations, err := OmgBlocksChainCheck(200000000000000000, "0xf968a82591026ba2371e800b38f2c2fb3947f932", "0x50beb1f82e461feecf6a1cc7a578a85ea004727c")
	if err != nil {
